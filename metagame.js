...
// var decks_json: JSON = await fs.readFile(
// 	"decks_json/decks-" + FORMATS[0] + ".json",
// 	"utf8",
// 	function (err: string, json: string) {
// 		JSON.parse(json);
// 		// console.log(JSON.stringify(decks_json));
// 	}
// );
// var decks_json: JSON = fs.readFileSync(
// 	"decks_json/decks-" + FORMATS[0] + ".json",
// 	"utf8"
// );
// var decks_json: JSON = await fs.readFile(
...
// ); // need
// function loadJson() {
// 	return fs.readFile("decks_json/decks-" + FORMATS[0] + ".json", "utf8");
// }
var decks_json = fs.readFile("decks_json/decks-" + FORMATS[0] + ".json", "utf8");
// (async () => {
// 	var decks_json: JSON = await fs.readFile(
// 		"decks_json/decks-" + FORMATS[0] + ".json",
// 		"utf8"
